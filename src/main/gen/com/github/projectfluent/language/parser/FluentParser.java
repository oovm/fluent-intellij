...
public class FluentParser implements PsiParser, LightPsiParser {
  ...
  public static boolean array(PsiBuilder b, int l) {
    ...
    r = bracket_block(b, l + 1, FluentParser::value, FluentParser::ignore);
  ...
  public static boolean object(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = brace_block(b, l + 1, FluentParser::kv_pair, FluentParser::ignore);
  ...
  public static boolean properties_block(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = brace_block(b, l + 1, FluentParser::properties_inner, FluentParser::ignore);
  ...
  public static boolean schema_statement(PsiBuilder b, int l) {
    ...
    r = r && brace_block(b, l + 1, FluentParser::properties_inner, FluentParser::ignore);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
